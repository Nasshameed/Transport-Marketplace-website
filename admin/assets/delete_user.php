<section class="py-5 px-5">
    <div class="col-sm-12 col-xl-12 py-5">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4 text-uppercase">Delete Users Information</h6>
                            <script>
    ...
    ?>
        <tr>
            ...
            <td class="text-uppercase">
                <a href="delete.php?id=<?php echo urlencode($row['id']); ?>" class="btn btn-danger small" title="View User Information">
